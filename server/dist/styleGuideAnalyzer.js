...
exports.analyzeStyleFromPrecedents = analyzeStyleFromPrecedents;
exports.getDefaultStyleGuide = getDefaultStyleGuide;
 ...
 */
async function analyzeStyleFromPrecedents(precedents, firmName) {
...
Return JSON in this exact format:
{
  ...
  "tone": "formal" | "conversational" | "technical"
        ...
        if (!result.ok) {
            logger_1.log.error("style guide analysis failed", { error: result.error });
        ...
        logger_1.log.info("style guide created", {
        ...
        logger_1.log.error("style guide analysis exception", { message: e.message });
